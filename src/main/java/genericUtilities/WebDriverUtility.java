...
public class WebDriverUtility {
	...
	public WebDriver launchbrowserAndMaximize(String browser) {
		switch (browser) {
		case "chrome":
			System.setProperty("webdriver.chromedriver", "./src/main/resources/chromedriver");
	 ...
	 * @param target
	 */
	public void mouseHoverToElement(WebElement element, WebElement target) {
	...
	/**
	 * This method fetches all the elements
	 * 
	 * @param element
	 * @return
	 */
	public List<WebElement> selectFromDropdown(WebElement element) {
		Select select = new Select(element);
